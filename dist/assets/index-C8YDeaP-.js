...
var Je=[{Icon:te,label:`Free Delivery`,sub:`On orders above ₹999`},{Icon:t,label:`COD Available`,sub:`Cash on delivery, PAN India`},{Icon:M,label:`Easy Returns`,sub:`Hassle-free, no questions asked`},{Icon:se,label:`100% Pure Cotton`,sub:`Long-staple, certified quality`},{Icon:ne,label:`Secure Checkout`,sub:`Razorpay encrypted payments`}];function Ye(){return(0,G.jsxs)(G.Fragment,{children:[(0,G.jsx)(`style`,{children:`
      ...
      `}}),(0,G.jsx)(`section`,{className:`luxury-story-section`,id:`brand-craftsmanship`,children:(0,G.jsxs)(`div`,{className:`luxury-story-container`,children:[(0,G.jsxs)(`div`,{className:`story-content-side`,children:[(0,G.jsx)(`span`,{className:`story-accent-tag`,children:`The Art of Looming`}),(0,G.jsx)(`h2`,{className:`story-main-title`,children:`100% Long-Staple Pure Cotton Weaves`}),(0,G.jsx)(`p`,{className:`story-body-text`,children:`Every creation under the catalog is engineered using high-density pure combed cotton. By employing artisanal, slower weaving patterns on conventional looms, we secure structural loops that retain their ultra-plush fluffiness and incredible moisture absorbency index year after year.`}),(0,G.jsxs)(`ul`,{className:`story-perks-list`,children:[(0,G.jsxs)(`li`,{className:`perk-item`,children:[(0,G.jsx)(`h4`,{className:`perk-title`,children:`Zero Twist Fibers`}),(0,G.jsx)(`p`,{className:`perk-desc`,children:`Naturally light yet profoundly thick, providing maximum plush luxury.`})]}),(0,G.jsxs)(`li`,{className:`perk-item`,children:[(0,G.jsx)(`h4`,{className:`perk-title`,children:`Eco-Safe Dyeing`}),(0,G.jsx)(`p`,{className:`perk-desc`,children:`Guaranteed free from harsh auxiliary chemicals and skin irritants.`})]})]}),(0,G.jsx)(x,{to:`/products`,className:`story-cta-btn`,children:`Explore Our Products`})]}),(0,G.jsxs)(`div`,{className:`story-media-side`,children:[(0,G.jsx)(`div`,{className:`main-media-frame`,children:(0,G.jsx)(`img`,{src:`/images/Use.jpeg`,alt:`Elevate Everyday Living - Premium Home Linen`,className:`main-media-img`})}),(0,G.jsxs)(`div`,{className:`overlapping-detail-box`,children:[(0,G.jsx)(`div`,{className:`detail-box-num`,children:`700+`}),(0,G.jsx)(`div`,{className:`detail-box-txt`,children:`Premium Thread Count & Density Threshold`})]})]})]})})]})}function $e(){let[e,t]=(0,B.useState)(0),n=[{id:0,text:`I recently bought cherry color bedsheet. I must say firstly i was nervous for purchasing online but i am v. Happy with the quality and look of the fabric. Will purchase more in coming`,author:`Ritu Khanna`},{id:1,text:`The premium hotel cotton bath towels are exceptionally thick and plush. Even after multiple laundering cycles, the loops retain their super soft texture and high absorbency index.`,author:`Ananya Sharma`},{id:2,text:`Stunning block-print craftsmanship on the Jaipuri Razai! It feels incredibly lightweight yet provides perfect cozy warmth. Highly recommend their organic cotton selections.`,author:`Vikram Malhotra`}];return(0,G.jsxs)(G.Fragment,{children:[(0,G.jsx)(`style`,{dangerouslySetInnerHTML:{__html:`
