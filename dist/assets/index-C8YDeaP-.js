...
#Follow Washcare Instructions Carefully.`,shippingRefund:X}},we={overview:`A premium quality product crafted with care. Details will be updated shortly.`,size:`Please refer to the size label on the product. Contact us for sizing assistance.`,material:`Made from high-quality materials. Exact composition listed on the product tag.`,careGuide:`Machine wash cold with like colours. Gentle cycle. Do not bleach. Tumble dry low. Iron on medium heat.`,shippingRefund:X};function Te(e){if(!e)return we;if(Z[e])return Z[e];let t=e.trim();if(Z[t])return Z[t];let n=t.toLowerCase(),r=Object.keys(Z),i=r.find(e=>e.trim().toLowerCase()===n);if(i)return Z[i];let a=new Set([`cotton`,`pure`,`premium`,`with`,`and`,`or`,`the`,`a`,`in`,`of`,`set`,`size`,`covers`,`cover`,`including`,`component`,`reversible`,`bedcover`,`bedsheet`,`dohar`,`fitted`,`quilted`,`kantha`,`pillow`]),o=e=>e.toLowerCase().split(/[\s|()\[\],]+/).filter(e=>e.length>1&&!a.has(e)&&!/^\d+$/.test(e)),s=o(t),c=null,l=0;for(let e of r){let t=s.filter(t=>o(e).includes(t)).length;t>l&&(l=t,c=e)}return c&&l>0?(console.log(`[PDP] fuzzy matched "${e}" -> "${c}" (score ${l})`),Z[c]):we}function Ee({products:e}){let{id:t}=re(),n=d(),[r,i]=(0,B.useState)(1),[a,o]=(0,B.useState)(!1),[s,c]=(0,B.useState)({text:``,isError:!1}),[l,u]=(0,B.useState)(0),[f,p]=(0,B.useState)(!1),[m,h]=(0,B.useState)({x:50,y:50}),[g,_]=(0,B.useState)(!1),[v,y]=(0,B.useState)(1),b=(0,B.useRef)(null),x=(0,B.useRef)(!1),S=(0,B.useRef)({x:50,y:50}),C=(0,B.useRef)({active:!1,moved:!1,startX:0,startY:0,originX:50,originY:50});(0,B.useEffect)(()=>{x.current=f},[f]),(0,B.useEffect)(()=>{S.current=m},[m]);let[w,D]=(0,B.useState)(`overview`),[O,k]=(0,B.useState)({reviews:[],count:0,avg:0,breakdown:{}}),[A,j]=(0,B.useState)(!1),[M,ee]=(0,B.useState)(!1),[P,F]=(0,B.useState)(0),[I,te]=(0,B.useState)(0),[ae,R]=(0,B.useState)(``),[z,oe]=(0,B.useState)(``),[se,ce]=(0,B.useState)(!1),[le,V]=(0,B.useState)(``),[de,fe]=(0,B.useState)(!1),[pe,me]=(0,B.useState)(!1),[U,W]=(0,B.useState)(`choose`),[ge,_e]=(0,B.useState)(!1),ve=(()=>{try{return JSON.parse(localStorage.getItem(`user`)||`null`)}catch{return null}})(),K=e?.find(e=>e._id===t);(0,B.useEffect)(()=>{t&&(j(!0),fetch(`${H}/reviews/${t}`).then(e=>e.json()).then(e=>k(e)).catch(()=>{}).finally(()=>j(!1)))},[t]);let ye=async e=>{if(e.preventDefault(),!P){V(`Please select a star rating.`);return}if(!z.trim()){V(`Please write a review.`);return}V(``),ce(!0);try{let e=await fetch(`${H}/reviews/${t}`,{method:`POST`,headers:{"Content-Type":`application/json`,Authorization:`Bearer ${localStorage.getItem(`token`)}`},body:JSON.stringify({rating:P,title:ae,body:z})}),n=await e.json();if(!e.ok){V(n.error||`Failed to submit review.`);return}fe(!0),ee(!1),F(0),R(``),oe(``),k(await fetch(`${H}/reviews/${t}`).then(e=>e.json()))}catch{V(`Network error. Please try again.`)}finally{ce(!1)}},q=K?K.images?.length>0?K.images:[K.image].filter(Boolean):[],J=()=>{K&&r<K.stock?i(e=>e+1):c({text:`⚠️ Only ${K?.stock} items available in stock.`,isError:!0})},xe=()=>{c({text:``,isError:!1}),i(e=>e>1?e-1:1)},Y=(e,t,n)=>{let r=n.getBoundingClientRect();return{x:Math.min(100,Math.max(0,(e-r.left)/r.width*100)),y:Math.min(100,Math.max(0,(t-r.top)/r.height*100))}},Se=e=>{h(Y(e.clientX,e.clientY,e.currentTarget))},X=e=>{if(!window.matchMedia(`(hover: hover) and (pointer: fine)`).matches){if(C.current.moved){C.current.moved=!1;return}h(Y(e.clientX,e.clientY,e.currentTarget)),p(e=>!e)}};(0,B.useEffect)(()=>{let e=b.current;if(!e)return;let t=1.75,n=e=>{if(!x.current||e.target.closest(`button`))return;let t=e.touches[0];C.current={active:!0,moved:!1,startX:t.clientX,startY:t.clientY,originX:S.current.x,originY:S.current.y},e.preventDefault()},r=n=>{if(!C.current.active)return;let r=n.touches[0],i=r.clientX-C.current.startX,a=r.clientY-C.current.startY;if((Math.abs(i)>4||Math.abs(a)>4)&&(C.current.moved=!0),!C.current.moved)return;let o=e.getBoundingClientRect();h({x:Math.min(100,Math.max(0,C.current.originX-i/t/o.width*100)),y:Math.min(100,Math.max(0,C.current.originY-a/t/o.height*100))}),n.preventDefault()},i=()=>{C.current.active=!1};return e.addEventListener(`touchstart`,n,{passive:!1}),e.addEventListener(`touchmove`,r,{passive:!1}),e.addEventListener(`touchend`,i),()=>{e.removeEventListener(`touchstart`,n),e.removeEventListener(`touchmove`,r),e.removeEventListener(`touchend`,i)}},[]);let Z=async()=>{if(!K||K.stock===0){c({text:`❌ This product is currently out of stock.`,isError:!0});return}let e=localStorage.getItem(`token`);if(!e){he(K,r),c({text:`🛒 Added to cart! Login to checkout with saved addresses.`,isError:!1}),setTimeout(()=>n(`/cart`),1200);return}o(!0),c({text:``,isError:!1});try{let t=await fetch(`${H}/cart/add`,{method:`POST`,headers:{"Content-Type":`application/json`,Authorization:`Bearer ${e}`},body:JSON.stringify({productId:K._id,quantity:Number(r)})}),i=await t.json();if(!t.ok)throw Error(i.error||i.message||`Failed to add to cart.`);c({text:`🛒 Added to cart!`,isError:!1}),setTimeout(()=>n(`/cart`),1200)}catch(e){c({text:`❌ ${e.message}`,isError:!0})}finally{o(!1)}},we=()=>{if(!K||K.stock===0){c({text:`❌ This product is currently out of stock.`,isError:!0});return}W(localStorage.getItem(`token`)?`loggedIn`:`choose`),window.scrollTo({top:0,behavior:`smooth`}),me(!0)},Ee=async(e,t,i)=>{_e(!0);try{let a=K.discountPrice??K.price,o=[{productId:K._id,name:K.name,price:a,quantity:r,image:q[0]||K.image||``,variant:K.size||`Standard`}],s=await fetch(`${H}/checkout/create-order`,{method:`POST`,headers:{"Content-Type":`application/json`,Authorization:`Bearer ${e}`},body:JSON.stringify({items:o,guestDeliveryAddress:i})}),c=await s.json();if(!s.ok)throw Error(c.error||`Failed to create payment order.`);let l={key:c.keyId,amount:c.amount,currency:`INR`,name:`Padmini Vastra`,description:K.name,image:`/images/logo_cutout.png`,order_id:c.id,prefill:{name:t.name,contact:t.phone},theme:{color:`#1c1c1a`},handler:async t=>{try{let r=await fetch(`${H}/checkout/verify-payment`,{method:`POST`,headers:{"Content-Type":`application/json`,Authorization:`Bearer ${e}`},body:JSON.stringify({razorpay_order_id:t.razorpay_order_id,razorpay_payment_id:t.razorpay_payment_id,razorpay_signature:t.razorpay_signature,items:o,guestDeliveryAddress:i})}),a=await r.json();r.ok&&a.success?(me(!1),alert(`Payment successful! Your order has been placed.`),n(`/`)):alert(`Payment verification failed. Please contact support.`)}catch(e){console.error(`Verify error:`,e),alert(`An error occurred during verification. Please contact support.`)}}},u=new window.Razorpay(l);u.on(`payment.failed`,e=>alert(`Payment failed: ${e.error.description}`)),u.open()}catch(e){alert(`Error: ${e.message}`)}finally{_e(!1)}};if(!e||e.length===0)return(0,G.jsx)(`div`,{style:{padding:`100px 20px`,textAlign:`center`,fontFamily:`sans-serif`,color:`#666`},children:(0,G.jsx)(`h3`,{children:`Loading Product Details...`})});if(!K)return(0,G.jsxs)(`div`,{style:{padding:`100px 20px`,textAlign:`center`,fontFamily:`sans-serif`},children:[(0,G.jsx)(`h3`,{style:{color:`#a61d24`},children:`Product Not Found`}),(0,G.jsx)(`p`,{style:{color:`#666`,fontSize:`14px`,marginTop:`10px`},children:`The item you are looking for does not exist or has been removed.`}),(0,G.jsx)(`button`,{onClick:()=>n(`/products`),style:{marginTop:`20px`,padding:`10px 20px`,cursor:`pointer`,background:`#1c242c`,color:`#fff`,border:`none`},children:`Go to Shop`})]});let De=q[l]||q[0]||``;return(0,G.jsxs)(G.Fragment,{children:[(0,G.jsx)(`style`,{children:`
      ...
      `}),(0,G.jsxs)(`div`,{className:`arrivals-container`,children:[(0,G.jsxs)(`div`,{className:`arrivals-breadcrumb`,children:[(0,G.jsx)(x,{to:`/`,children:(0,G.jsx)(i,{size:12,style:{marginBottom:-1}})}),(0,G.jsx)(p,{size:10}),(0,G.jsx)(x,{to:`/products`,children:`Shop`}),(0,G.jsx)(p,{size:10}),(0,G.jsx)(`span`,{style:{color:`#1c1c1a`,fontWeight:500},children:`New Arrivals`})]}),(0,G.jsxs)(`header`,{className:`arrivals-editorial-header`,children:[(0,G.jsxs)(`div`,{className:`arrivals-badge-label`,children:[(0,G.jsx)(O,{size:11,strokeWidth:2.5}),` Season Edition`]}),(0,G.jsx)(`h1`,{className:`arrivals-main-heading`,children:`The New Arrival Collection`}),(0,G.jsx)(`p`,{className:`arrivals-sub-paragraph`,children:`Experience our latest weave releases. Crafted from 100% elite long-staple premium combed cotton linen, designed to introduce signature luxury textures into your bedroom environment.`})]}),o&&(0,G.jsxs)(`div`,{style:{color:`#a61d24`,marginBottom:`30px`,textAlign:`center`},children:[`⚠️ `,o]}),c.length===0?(0,G.jsxs)(`div`,{className:`empty-arrivals-view`,children:[(0,G.jsx)(`h3`,{children:`Fresh Stock Launching Soon`}),(0,G.jsx)(`p`,{children:`Our artisans are finalizing our upcoming linen sets. Explore our current collections in the meantime.`}),(0,G.jsxs)(x,{to:`/products`,style:{display:`inline-flex`,alignItems:`center`,gap:`6px`,color:`#1c1c1a`,fontWeight:500,fontSize:`13px`,marginTop:`14px`,textDecoration:`underline`},children:[`Browse Main Shop `,(0,G.jsx)(_,{size:14})]})]}):(0,G.jsx)(`div`,{className:`arrivals-products-grid`,children:c.map(e=>(0,G.jsx)(Re,{product:e},e._id))})]})]})}function Be(){return(0,G.jsxs)(G.Fragment,{children:[(0,G.jsx)(`style`,{children:`
      ...
      `}),(0,G.jsx)(`img`,{src:`https://broad-pink-npkwccgw.edgeone.app/IMG_20260605_160712.png`,alt:`Padmini Vastra Living`,className:`cu-hero`}),(0,G.jsxs)(`div`,{className:`cu-wrapper`,children:[(0,G.jsx)(`h1`,{className:`cu-title`,children:`Contact Us`}),(0,G.jsx)(`p`,{className:`cu-tagline`,children:`Thank you for visiting us!`}),(0,G.jsx)(`div`,{className:`cu-block`,children:(0,G.jsxs)(`p`,{children:[`For any help / information, write to us at`,` `,(0,G.jsx)(`a`,{href:`mailto:padminivastra@gmail.com`,children:`padminivastra@gmail.com`})]})}),(0,G.jsx)(`div`,{className:`cu-divider`}),(0,G.jsx)(`div`,{className:`cu-block`,children:(0,G.jsxs)(`p`,{children:[`You can call / WhatsApp us at`,` `,(0,G.jsx)(`a`,{href:`https://wa.me/919990901656`,children:`+91 99909 01656`})]})}),(0,G.jsx)(`div`,{className:`cu-divider`}),(0,G.jsx)(`div`,{className:`cu-block`,children:(0,G.jsxs)(`p`,{children:[`Instagram —`,` `,(0,G.jsx)(`a`,{href:`https://www.instagram.com/padminivastra`,target:`_blank`,rel:`noopener noreferrer`,children:`@padminivastra`})]})}),(0,G.jsx)(`div`,{className:`cu-divider`}),(0,G.jsx)(`div`,{className:`cu-block`,children:(0,G.jsxs)(`p`,{className:`cu-address`,children:[(0,G.jsx)(`strong`,{children:`Office Address`}),(0,G.jsx)(`br`,{}),`2033, ATS Dolce, Sector Zeta 1`,(0,G.jsx)(`br`,{}),`Greater Noida — 201310`,(0,G.jsx)(`br`,{}),`Uttar Pradesh, India`]})})]})]})}var Ge=[{image:`/images/hero_banner.jpg`,fallback:`/images/hero_banner.jpg`,badge:`Indian Handloom Saree Collection`,title:`Padmini Vastra`,subtitle:`More than fashion, it’s a feeling 💕`,cta:`Shop Collection`,link:`/products`},{image:`https://images.unsplash.com/photo-1610030469983-98e550d6193c?q=80&w=1200`,fallback:`https://images.unsplash.com/photo-1610030469983-98e550d6193c?q=80&w=1200`,badge:`Summer Cotton Collection`,title:`Kalyani & Mulcotton`,subtitle:`Lightweight drapes celebrating Indian heritage`,cta:`Explore Cottons`,link:`/products/kalyani-cotton-saree`},{image:`https://images.unsplash.com/photo-1617627143750-d86bc21e42bb?q=80&w=1200`,fallback:`https://images.unsplash.com/photo-1617627143750-d86bc21e42bb?q=80&w=1200`,badge:`Royal Silk Festives`,title:`Soft & Gini Silks`,subtitle:`Pure silk woven into gold thread templates`,cta:`Explore Silks`,link:`/products/soft-silk-saree`}],Ke=Ge.length;function qe(){let[e,t]=(0,B.useState)(0),[n,r]=(0,B.useState)(!1),i=(0,B.useRef)(0),a=(0,B.useRef)(!1),o=(0,B.useRef)(null);(0,B.useEffect)(()=>{i.current=e},[e]);let s=(0,B.useCallback)(e=>{let n=(e%Ke+Ke)%Ke;r(!0),setTimeout(()=>{t(n),r(!1)},450)},[]),c=(0,B.useCallback)(()=>{clearInterval(o.current),o.current=setInterval(()=>{a.current||s(i.current+1)},5e3)},[s]);(0,B.useEffect)(()=>(c(),()=>clearInterval(o.current)),[c]);let l=e=>{s(e),c()},u=Ge[e]??Ge[0];return(0,G.jsxs)(G.Fragment,{children:[(0,G.jsx)(`style`,{children:`
          ...
          `}),(0,G.jsx)(`div`,{style:{width:`100%`,backgroundColor:`#fff`,overflow:`visible`,position:`relative`,zIndex:1},children:(0,G.jsxs)(B.Fragment,{children:[(0,G.jsxs)(`section`,{className:`hero-wrapper`,style:{position:`relative`,height:`70vh`,overflow:`hidden`,backgroundColor:`#111`},onMouseEnter:()=>{a.current=!0},onMouseLeave:()=>{a.current=!1},children:[Ge.map((t,n)=>(0,G.jsx)(`img`,{src:t.image,alt:t.title,className:`hero-slide-img${n===e?` hero-slide-active`: ``}`,onError:e=>{e.target.onerror=null,e.target.src=t.fallback}},n)),(0,G.jsx)(`button`,{className:`hero-arrow left`,onClick:()=>l(e-1),"aria-label":`Previous`,children:`‹`}),(0,G.jsx)(`button`,{className:`hero-arrow right`,onClick:()=>l(e+1),"aria-label":`Next`,children:`›`})]}),(0,G.jsx)(`div`,{className:`hero-text-section`,children:(0,G.jsxs)(`div`,{style:{maxWidth:`800px`,margin:`0 auto`},children:[(0,G.jsx)(`span`,{className:`hero-intro-badge`,children:`Indian Handloom Saree Collection`}),(0,G.jsx)(`h1`,{className:`hero-intro-title`,children:`Padmini Vastra`}),(0,G.jsx)(`p`,{className:`hero-intro-subtitle`,children:`More than fashion, it’s a feeling 💕`}),(0,G.jsx)(x,{to:`/products`,className:`hero-intro-cta`,children:`Shop Collection`})]})})]})})]});
}


var Je=[{Icon:te,label:`Free Delivery`,sub:`On orders above ₹999`},{Icon:t,label:`COD Available`,sub:`Cash on delivery, PAN India`},{Icon:M,label:`Easy Returns`,sub:`Hassle-free, no questions asked`},{Icon:se,label:`100% Pure Cotton`,sub:`Long-staple, certified quality`},{Icon:ne,label:`Secure Checkout`,sub:`Razorpay encrypted payments`}];function Ye(){return(0,G.jsxs)(G.Fragment,{children:[(0,G.jsx)(`style`,{children:`
        .usp-strip {
          background: #fafaf7;
          border-top: 1px solid #ebebeb;
      ...
      `}),(0,G.jsx)(`div`,{className:`usp-strip`,children:(0,G.jsx)(`div`,{className:`usp-inner`,children:Je.map(({Icon:e,label:t,sub:n},r)=>(0,G.jsxs)(B.Fragment,{children:[r>0&&(0,G.jsx)(`div`,{className:`usp-divider`}),(0,G.jsxs)(`div`,{className:`usp-item`,children:[(0,G.jsx)(`div`,{className:`usp-icon-wrap`,children:(0,G.jsx)(e,{size:17,strokeWidth:1.8})}),(0,G.jsxs)(`div`,{children:[(0,G.jsx)(`div`,{className:`usp-text-label`,children:t}),(0,G.jsx)(`div`,{className:`usp-text-sub`,children:n})]})]})]},t))})})]})}function Xe(){return(0,G.jsxs)(G.Fragment,{children:[(0,G.jsx)(`style`,{dangerouslySetInnerHTML:{__html:`
        ...
        .force-horizontal-card { width: 23.5% !important; flex: 0 0 23.5% !important; display: flex !important; flex-direction: column !important; text-decoration: none !important; background: none !important; border: none !important; padding: 0 !important; margin: 0 !important; cursor: pointer !important; box-sizing: border-box !important; }
      ...
      `}}),(0,G.jsxs)(`section`,{className:`force-horizontal-section`,id:`explore-collections`,children:[(0,G.jsx)(`h2`,{className:`force-horizontal-heading`,children:`What are you looking for?`}),(0,G.jsx)(`div`,{className:`force-horizontal-grid`,children:[{url:`/products/kalyani-cotton-saree`,name:`Kalyani Cotton`,type:`media`,image:`https://images.unsplash.com/photo-1610030469983-98e550d6193c?q=80&w=400`},{url:`/products/khadi-embroidery-saree`,name:`Khadi Embroidery`,type:`media`,image:`https://images.unsplash.com/photo-1617627143750-d86bc21e42bb?q=80&w=400`},{url:`/products/mul-cotton-saree`,name:`Mul Cotton`,type:`media`,image:`https://images.unsplash.com/photo-1609357605129-26f69add5d6e?q=80&w=400`},{url:`/products/gini-tissue-saree`,name:`Gini Tissue`,type:`media`,image:`https://images.unsplash.com/photo-1610030469668-93535c17b6b3?q=80&w=400`},{url:`/products/soft-silk-saree`,name:`Soft Silk`,type:`media`,image:`https://images.unsplash.com/photo-1583391733956-3750e0ff4e8b?q=80&w=400`},{url:`/products/border-less-soft-silk-saree`,name:`Borderless Silk`,type:`media`,image:`https://images.unsplash.com/photo-1621184455862-c163dfb30e0f?q=80&w=400`},{url:`/products/plain-soft-silk-saree`,name:`Plain Silk`,type:`media`,image:`https://images.unsplash.com/photo-1610030470200-2d93e1112b32?q=80&w=400`},{url:`/products/champion-silk-saree`,name:`Champion Silk`,type:`media`,image:`https://images.unsplash.com/photo-1625733143873-d8ec459a110a?q=80&w=400`},{url:`/products/ds-kottanchi-saree`,name:`Ds Kottanchi`,type:`media`,image:`https://images.unsplash.com/photo-1561414927-6d86591d0c4f?q=80&w=400`}].map((e,t)=>e.type===`text-only`?(0,G.jsx)(x,{to:e.url,className:`force-horizontal-card text-only-variant`,children:(0,G.jsxs)(`span`,{className:`force-horizontal-label`,children:[e.name,` →`]})},t):(0,G.jsxs)(x,{to:e.url,className:`force-horizontal-card`,children:[(0,G.jsx)(`div`,{className:`force-horizontal-wrapper`,children:(0,G.jsx)(`img`,{src:e.image,alt:`${e.name} Collection`,className:`force-horizontal-img`,loading:`lazy`,onError:t=>{t.target.src=`https://placehold.co/400x500?text=${e.name}`}})}),(0,G.jsxs)(`span`,{className:`force-horizontal-label`,children:[e.name,` →`]})]},t))})]})]})}function Ze({products:e=[]}){let t=(()=>{let t=e.filter(e=>e.stock>0);return(t.length>=5?t:e).slice(0,5)})();return(0,G.jsxs)(G.Fragment,{children:[(0,G.jsx)(`style`,{dangerouslySetInnerHTML:{__html:`
        .bestsellers-section {
          max-width: 100vw;
          margin: 0 auto;
          padding: 60px 60px;
      ...
      `}}),(0,G.jsxs)(`section`,{className:`bestsellers-section`,id:`best-sellers-vault`,children:[(0,G.jsx)(`h2`,{className:`section-header-title`,children:`Our Bestsellers`}),(0,G.jsx)(`p`,{className:`section-header-tagline`,children:`Handpicked from our most loved collections`}),(0,G.jsx)(`div`,{className:`bestsellers-grid`,children:t.length===0?Array.from({length:5}).map((e,t)=>(0,G.jsxs)(`div`,{className:`product-card`,style:{animationDelay:`${t*90}ms`},children:[(0,G.jsx)(`div`,{className:`product-image-container bs-skeleton`}),(0,G.jsx)(`div`,{className:`bs-skeleton`,style:{height:12,width:`80%`,borderRadius:6,marginBottom:8}}),(0,G.jsx)(`div`,{className:`bs-skeleton`,style:{height:12,width:`55%`,borderRadius:6}})]},t)):t.map((e,t)=>{let n=e.discountPrice??e.price,r=e.discountPercent>0,i=e.createdAt&&Date.now()-new Date(e.createdAt).getTime()<720*3600*1e3;return(0,G.jsxs)(x,{to:`/product/${e._id}`,className:`product-card`,style:{animationDelay:`${t*90}ms`},children:[(0,G.jsxs)(`div`,{className:`product-image-container`,children:[(0,G.jsxs)(`div`,{className:`badge-stack`,children:[(0,G.jsx)(`span`,{className:`luxury-badge bestseller`,children:`Bestseller`}),i&&(0,G.jsx)(`span`,{className:`luxury-badge new-arrival`,children:`New`}),r&&(0,G.jsxs)(`span`,{className:`luxury-badge sale`,children:[`-`,e.discountPercent,`%`]})]}),(0,G.jsx)(`img`,{src:e.image||`https://placehold.co/400x500?text=Padmini Vastra`,alt:e.name,className:`product-main-img`,loading:`lazy`,onError:e=>{e.target.src=`https://placehold.co/400x500?text=Padmini Vastra`}})]}),(0,G.jsx)(`h3`,{className:`product-title`,children:e.name}),(0,G.jsxs)(`div`,{className:`product-price-row`,children:[(0,G.jsxs)(`span`,{className:`product-price-current`,children:[`Rs. `,Number(n).toLocaleString(`en-IN`,{minimumFractionDigits:2})]}),r&&(0,G.jsxs)(`span`,{className:`product-price-original`,children:[`Rs. `,Number(e.price).toLocaleString(`en-IN`,{minimumFractionDigits:2})]})]}),(0,G.jsx)(`span`,{className:`product-shop-link`,children:`Shop Now →`})]},e._id)})}),(0,G.jsx)(x,{to:`/products`,className:`bs-view-all`,children:`View All Products →`})]})]})}function Qe(){return(0,G.jsxs)(G.Fragment,{children:[(0,G.jsx)(`style`,{dangerouslySetInnerHTML:{__html:`
      ...
      `}}),(0,G.jsx)(`section`,{className:`luxury-story-section`,id:`brand-craftsmanship`,children:(0,G.jsxs)(`div`,{className:`luxury-story-container`,children:[(0,G.jsxs)(`div`,{className:`story-content-side`,children:[(0,G.jsx)(`span`,{className:`story-accent-tag`,children:`The Art of Looming`}),(0,G.jsx)(`h2`,{className:`story-main-title`,children:`Celebrating Handloom Craftsmanship`}),(0,G.jsx)(`p`,{className:`story-body-text`,children:`Every Padmini Vastra saree is a product of love, patience, and generations of weaving heritage. Sourced directly from rural Indian weaving clusters, our artisans use conventional wooden handlooms to create authentic Kalyani Cotton, Mulcotton, Linen, and Silk sarees of unmatched grace and breathability.`}),(0,G.jsxs)(`ul`,{className:`story-perks-list`,children:[(0,G.jsxs)(`li`,{className:`perk-item`,children:[(0,G.jsx)(`h4`,{className:`perk-title`,children:`Hand-woven Zari`}),(0,G.jsx)(`p`,{className:`perk-desc`,children:`Intricate borders woven by hand with gold and silver thread.`})]}),(0,G.jsxs)(`li`,{className:`perk-item`,children:[(0,G.jsx)(`h4`,{className:`perk-title`,children:`100% Pure Organic Dyes`}),(0,G.jsx)(`p`,{className:`perk-desc`,children:`Skin-safe natural colorings sourced from organic minerals.`})]})]}),(0,G.jsx)(x,{to:`/products`,className:`story-cta-btn`,children:`Explore Our Products`})]}),(0,G.jsxs)(`div`,{className:`story-media-side`,children:[(0,G.jsx)(`div`,{className:`main-media-frame`,children:(0,G.jsx)(`img`,{src:`https://images.unsplash.com/photo-1610030469668-93535c17b6b3?q=80&w=800`,alt:`Authentic Handloom Saree Weaving Craftsmanship`,className:`main-media-img`})}),(0,G.jsxs)(`div`,{className:`overlapping-detail-box`,children:[(0,G.jsx)(`div`,{className:`detail-box-num`,children:`700+`}),(0,G.jsx)(`div`,{className:`detail-box-txt`,children:`Premium Thread Count & Density Threshold`})]})]})]})})]})}function $e(){let[e,t]=(0,B.useState)(0),n=[{id:0,text:`I recently bought cherry color Mul Cotton saree. I must say firstly i was nervous for purchasing online but i am v. Happy with the quality and look of the fabric. Will purchase more in coming`,author:`Ritu Khanna`},{id:1,text:`The Kalyani cotton and soft silk sarees are exceptionally light and premium. Even after multiple wears, the handloom fabric retains its soft texture and graceful fall.`,author:`Ananya Sharma`},{id:2,text:`Stunning thread craftsmanship on the Gini Tissue saree! It feels incredibly lightweight yet provides a highly elegant and premium look. Highly recommend their handloom collections.`,author:`Vikram Malhotra`}];return(0,G.jsxs)(G.Fragment,{children:[(0,G.jsx)(`style`,{dangerouslySetInnerHTML:{__html:`
      ...
      `}),(0,G.jsxs)(`div`,{className:`orders-page-container`,children:[(0,G.jsx)(`div`,{className:`orders-back-nav`,children:(0,G.jsxs)(x,{to:`/`,className:`orders-back-btn`,children:[(0,G.jsx)(ue,{size:14}),` Back to Home`]})}),(0,G.jsx)(`h1`,{className:`orders-page-title`,children:`My Orders`}),i&&(0,G.jsxs)(`div`,{className:`error-message-box`,children:[`⚠️ `,i]}),e.length===0?(0,G.jsxs)(`div`,{className:`order-card-empty`,children:[(0,G.jsx)(`div`,{className:`empty-icon-box`,children:(0,G.jsx)(k,{size:48,strokeWidth:1.5})}),(0,G.jsx)(`h2`,{className:`empty-headline`,children:`No Orders Found`}),(0,G.jsx)(`p`,{className:`empty-text`,children:`You haven't placed any premium orders with us yet.`}),(0,G.jsx)(x,{to:`/products`,className:`shop-btn-luxury`,children:`Explore Collections`})]}):e.map(e=>(0,G.jsxs)(`div`,{className:`order-card-wrapper`,children:[(0,G.jsxs)(`div`,{className:`order-card-header`,children:[(0,G.jsxs)(`div`,{className:`header-meta-group`,children:[(0,G.jsxs)(`div`,{className:`meta-item`,children:[(0,G.jsxs)(`label`,{children:[(0,G.jsx)(l,{size:10,style:{marginRight:4}}),` Date Placed`]}),(0,G.jsx)(`span`,{children:new Date(e.createdAt).toLocaleDateString(`en-IN`,{day:`numeric`,month:`long`,year:`numeric`})})]}),(0,G.jsxs)(`div`,{className:`meta-item`,children:[(0,G.jsxs)(`label`,{children:[(0,G.jsx)(a,{size:10,style:{marginRight:2}}),` Total Amount`]}),(0,G.jsxs)(`span`,{children:[`₹`,e.totalAmount.toLocaleString(`en-IN`,{minimumFractionDigits:2})]})]}),(0,G.jsxs)(`div`,{className:`meta-item`,children:[(0,G.jsxs)(`label`,{children:[(0,G.jsx)(le,{size:10,style:{marginRight:4}}),` Status`]}),(0,G.jsx)(`span`,{style:{color:e.status===`Paid`?`#166534`:`#8b7355`,textTransform:`uppercase`,fontSize:`12px`,fontWeight:600},children:e.status})]})]}),(0,G.jsxs)(`div`,{className:`order-id-display meta-item`,children:[(0,G.jsx)(`label`,{children:`Order Reference ID`}),(0,G.jsxs)(`span`,{style:{fontFamily:`monospace`,color:`#7c7c75`},children:[`#`,e.razorpayOrderId]})]})]}),(0,G.jsx)(`div`,{className:`order-card-body`,children:e.items.map((e,t)=>(0,G.jsxs)(`div`,{className:`order-item-row`,children:[(0,G.jsx)(`div`,{className:`order-item-img`,children:(0,G.jsx)(`img`,{src:e.image||`https://placehold.co/150x150?text=Bedding`,alt:e.name})}),(0,G.jsxs)(`div`,{className:`order-item-details`,children:[(0,G.jsx)(`h4`,{children:e.name}),(0,G.jsxs)(`div`,{className:`order-item-meta`,children:[(0,G.jsxs)(`div`,{children:[`Variant: `,e.variant||`Standard`]}),(0,G.jsxs)(`div`,{children:[`Quantity: `,e.quantity]})]})]}),(0,G.jsxs)(`div`,{className:`order-item-price`,children:[`₹`,(e.price*e.quantity).toLocaleString(`en-IN`,{minimumFractionDigits:2})]})]},e._id||t))})]},e._id))]})]})}var rt={"best-sellers":{category:[],subcategory:[],label:`Best Sellers`,breadcrumb:[]},"kalyani-cotton-saree":{category:[`kalyani-cotton-saree`],subcategory:[],label:`Kalyani Cotton Saree`,breadcrumb:[]},"khadi-embroidery-saree":{category:[`khadi-embroidery-saree`],subcategory:[],label:`Khadi Embroidery Saree`,breadcrumb:[]},"mul-cotton-saree":{category:[`mul-cotton-saree`],subcategory:[],label:`Mul Cotton Saree`,breadcrumb:[]},"gini-tissue-saree":{category:[`gini-tissue-saree`],subcategory:[],label:`Gini Tissue Saree`,breadcrumb:[]},"plain-soft-silk-saree":{category:[`plain-soft-silk-saree`],subcategory:[],label:`Plain Soft Silk Saree`,breadcrumb:[]},"border-less-soft-silk-saree":{category:[`border-less-soft-silk-saree`],subcategory:[],label:`Border less Soft Silk Saree`,breadcrumb:[]},"champion-silk-saree":{category:[`champion-silk-saree`],subcategory:[],label:`Champion Silk Saree`,breadcrumb:[]},"soft-silk-saree":{category:[`soft-silk-saree`],subcategory:[],label:`Soft Silk Saree`,breadcrumb:[]},"ds-kottanchi-saree":{category:[`ds-kottanchi-saree`],subcategory:[],label:`Ds Kottanchi Saree`,breadcrumb:[]}},it={"kalyani-cotton-saree":`Kalyani Cotton Saree`,"khadi-embroidery-saree":`Khadi Embroidery Saree`,"mul-cotton-saree":`Mul Cotton Saree`,"gini-tissue-saree":`Gini Tissue Saree`,"plain-soft-silk-saree":`Plain Soft Silk Saree`,"border-less-soft-silk-saree":`Border less Soft Silk Saree`,"champion-silk-saree":`Champion Silk Saree`,"soft-silk-saree":`Soft Silk Saree`,"ds-kottanchi-saree":`Ds Kottanchi Saree`};function at({product:e,isLiked:t,onToggleWishlist:n}){let r=e.stock===0,[i,a]=(0,B.useState)(!1),[o,s]=(0,B.useState)(!1);return(0,G.jsxs)(`div`,{className:`towels-product-card${r?` card-disabled`:``}`,children:[(0,G.jsxs)(`div`,{className:`towels-img-wrap`,children:[(0,G.jsx)(x,{to:`/product/${e._id}`,children:(0,G.jsx)(`img`,{src:e.image,alt:e.name,className:`towels-img`})}),r?(0,G.jsx)(`span`,{className:`towels-badge-out-of-stock`,children:`OUT OF STOCK`}):e.discountPercent>0&&(0,G.jsxs)(`span`,{className:`towels-badge-discount`,children:[`SAVE `,e.discountPercent,`%`]}),(0,G.jsx)(`button`,{className:`towels-wishlist-btn`,onClick:()=>n(e._id),"aria-label":`Toggle Wishlist`,children:(0,G.jsx)(h,{size:18,fill:t?`#a61d24`:`none`,stroke:t?`#a61d24`:`#222222`,style:{transition:`all 0.2s ease`}})}),!r&&(0,G.jsx)(x,{to:`/product/${e._id}`,className:`towels-view-overlay`,children:`View Product →`})]}),(0,G.jsxs)(`div`,{className:`towels-card-body`,children:[(0,G.jsx)(`div`,{className:`towels-card-name`,children:e.name}),(0,G.jsxs)(`div`,{className:`towels-card-price-row`,children:[(0,G.jsxs)(`div`,{style:{display:`flex`,alignItems:`baseline`,gap:`8px`},children:[(0,G.jsxs)(`span`,{className:`towels-card-price`,children:[`Rs. `,Number(e.discountPrice).toFixed(2)]}),e.discountPrice<e.price&&(0,G.jsxs)(`span`,{className:`towels-card-price-original`,children:[`Rs. `,Number(e.price).toFixed(2)]})]}),(0,G.jsx)(`span`,{style:{fontSize:`10px`,color:`#888`,marginTop:`4px`},children:r?`Unavailable`:`Only ${e.stock} left`})]}),(0,G.jsx)(`button`,{className:`towels-add-cart-btn`,onClick:async t=>{if(t.preventDefault(),t.stopPropagation(),r||i)return;let n=localStorage.getItem(`token`);if(!n){he(e,1),s(!0),setTimeout(()=>s(!1),1500);return}a(!0);try{if(!(await fetch(`http://localhost:5000/api/cart/add`,{method:`POST`,headers:{"Content-Type":`application/json`,Authorization:`Bearer ${n}`},body:JSON.stringify({productId:e._id,quantity:1})})).ok)throw Error(`Failed to add to cart`);s(!0),setTimeout(()=>s(!1),1500)}catch{}finally{a(!1)}},disabled:r||i,children:r?`Out of Stock`:i?`Adding…`:o?`Added ✓`:`Add to Cart`})]})]})}function ot(){let{category:e}=re(),[t]=u(),n=t.get(`size`),r=(t.get(`q`)||``).trim(),[a,o]=(0,B.useState)([]),[s,c]=(0,B.useState)([]),[l,d]=(0,B.useState)(!0),[f,m]=(0,B.useState)(null),[h,g]=(0,B.useState)(`best-selling`),[_,v]=(0,B.useState)(!1);(0,B.useEffect)(()=>(document.body.style.overflow=_?`hidden`:``,()=>{document.body.style.overflow=``}),[_]);let[y,b]=(0,B.useState)({productType:[],size:[],minPrice:0,maxPrice:6e3});(0,B.useEffect)(()=>{b({productType:[],size:n?[n.toLowerCase()]:[],minPrice:0,maxPrice:6e3})},[e,n]),(0,B.useEffect)(()=>{(async()=>{try{d(!0);let e=await fetch(`${H}/products`);if(!e.ok)throw Error(`Failed to fetch products.`);o(await e.json());let t=localStorage.getItem(`token`);if(t){let e=await fetch(`${H}/wishlist`,{headers:{Authorization:`Bearer ${t}`}});e.ok&&c((await e.json()).map(e=>e._id||e))}}catch(e){m(e.message)}finally{d(!1)}})()},[]);let S=async e=>{let t=localStorage.getItem(`token`);if(!t){alert(`Please log in to add to wishlist.`);return}let n=s.includes(e);c(t=>n?t.filter(t=>t!==e):[...t,e]);try{(await fetch(`http://localhost:5000/api/wishlist/toggle`,{method:`POST`,headers:{"Content-Type":`application/json`,Authorization:`Bearer ${t}`},body:JSON.stringify({productId:e})})).ok||c(t=>n?[...t,e]:t.filter(t=>t!==e))}catch{c(t=>n?[...t,e]:t.filter(t=>t!==e))}},C=(0,B.useMemo)(()=>rt[e]||{category:[],subcategory:[],label:`All Products`,breadcrumb:[]},[e]),w=(0,B.useMemo)(()=>a.filter(e=>{let t=(e.category||``).toLowerCase(),n=(e.subcategory||``).toLowerCase();return!(C.category.length&&!C.category.includes(t)||C.subcategory.length&&!C.subcategory.includes(n))}),[a,C]),T=(0,B.useMemo)(()=>w.reduce((e,t)=>{let n=t.category?.toLowerCase();return n&&e[n]!==void 0&&e[n]++,e},{"kalyani-cotton-saree":0,"khadi-embroidery-saree":0,"mul-cotton-saree":0,"gini-tissue-saree":0,"plain-soft-silk-saree":0,"border-less-soft-silk-saree":0,"champion-silk-saree":0,"soft-silk-saree":0,"ds-kottanchi-saree":0}),[w]),E=(0,B.useMemo)(()=>{let e=new Set;return w.forEach(t=>{t.size?.trim()&&e.add(t.size.trim())}),[...e].sort()},[w]),D=(e,t)=>b(n=>({...n,[e]:n[e].includes(t)?n[e].filter(e=>e!==t):[...n[e],t]})),O=(0,B.useMemo)(()=>{let e=[...w];if(r){let t=r.toLowerCase();e=e.filter(e=>(e.name||``).toLowerCase().includes(t)||(e.subcategory||``).toLowerCase().includes(t)||(e.category||``).toLowerCase().includes(t)||(e.size||``).toLowerCase().includes(t))}return y.productType.length&&(e=e.filter(e=>y.productType.includes((e.category||``).toLowerCase()))),y.size.length&&(e=e.filter(e=>{let t=(e.size||``).trim().toLowerCase();return y.size.some(e=>t.includes(e.toLowerCase()))})),e=e.filter(e=>{let t=Number(e.discountPrice??e.price??0);return t>=y.minPrice&&t<=y.maxPrice}),h===`price-asc`&&e.sort((e,t)=>(e.discountPrice||e.price)-(t.discountPrice||t.price)),h===`price-desc`&&e.sort((e,t)=>(t.discountPrice||t.price)-(e.discountPrice||e.price)),e},[w,r,y,h]),k=C.category.length===0?[`kalyani-cotton-saree`,`khadi-embroidery-saree`,`mul-cotton-saree`,`gini-tissue-saree`,`plain-soft-silk-saree`,`border-less-soft-silk-saree`,`champion-silk-saree`,`soft-silk-saree`,`ds-kottanchi-saree`]:C.category.length>1?C.category:[];return(0,G.jsxs)(G.Fragment,{children:[(0,G.jsx)(`style`,{children:`
